...
export OUTPUT_DIR="${OUTPUT_DIR:-${PUBLIC_ROOT}/outputs/qwen3_vl_stage2_lora}"
export ADAPTER_NAME_OR_PATH="${ADAPTER_NAME_OR_PATH:-${PUBLIC_ROOT}/outputs/qwen3_vl_stage1_lora}"
